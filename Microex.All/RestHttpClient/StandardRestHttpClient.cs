...
{
    public class StandardRestHttpClient : IRestHttpClient
    {
        private HttpClient _client;
        private ILogger<StandardRestHttpClient> _logger;

        public StandardRestHttpClient(ILogger<StandardRestHttpClient> logger)
        {
