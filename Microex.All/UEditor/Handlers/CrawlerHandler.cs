    ...
    public class Crawler
    {
        ...
        public Crawler Fetch()
        {
            ...
            using (var response = request.GetResponseAsync().Result as HttpWebResponse)
            {
                ...
                ServerUrl = PathFormatter.Format(Path.GetFileName(this.SourceUrl), Handler.Config.CatcherPathFormat);
                var savePath = Path.Combine(Handler.WebRootPath, ServerUrl);
