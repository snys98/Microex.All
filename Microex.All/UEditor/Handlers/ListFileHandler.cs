    ...
    internal class ListFileManager : Handler
    {
        ...
        public override void Process()
        {
            try
            {
                ...
                Size = String.IsNullOrEmpty(Request.Query["size"]) ? Config.ImageManagerListSize : Convert.ToInt32(Request.Query["size"]);
            }
            ...
            try
            {
                var localPath = Path.Combine(WebRootPath,PathToList);
